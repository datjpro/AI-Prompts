      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="px-5 sm:px-8 lg:px-12 flex items-center gap-3 mb-6 sm:mb-8">
          <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-gray-900 text-white flex items-center justify-center flex-shrink-0">
            <span className="text-[11px] sm:text-[12px] font-semibold">2</span>
          </div>
        ...
        <div className="px-5 sm:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-7">
          ...
          <div>
            <div className="relative aspect-[329/246] rounded-2xl overflow-hidden bg-[#1a1d2e] group cursor-pointer">
              ...
              <div className="absolute bottom-4 left-4">
                <div className="bg-white h-9 w-9 group-hover:w-[148px] rounded-full flex items-center gap-2 px-2.5 transition-all duration-300 ease-in-out overflow-hidden">
                  ...
                  <svg
                    ...
                    className="text-gray-900 flex-shrink-0 -rotate-45 group-hover:rotate-0 transition-transform duration-300 ease-in-out"
                  >
          ...
          <div>
            <div className="relative aspect-square rounded-2xl overflow-hidden bg-[#6b6b6b] group cursor-pointer">
              ...
              {/* Hover button */}
              <div className="absolute bottom-4 left-4">
                <div className="bg-gray-900 h-9 w-9 group-hover:w-[168px] rounded-full flex items-center gap-2 px-2.5 transition-all duration-300 ease-in-out overflow-hidden">
                  ...
                  <ArrowRight
                    size={14}
                    className="text-white flex-shrink-0 -rotate-45 group-hover:rotate-0 transition-transform duration-300 ease-in-out"
                  />
                </div>
              </div>
            </div>
